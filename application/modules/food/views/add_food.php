...
<?php
    ...
    echo form_open_multipart('food/add_food',$attr);
?>
<div class="container">
        <div class="row">
...
<!--เพื่มรูป-->    <hr>
                ...
                <div class="card-body card-padding">
                    <div class="form-group">
                        <label class="col-sm-3 col-xs-2 control-label">เมนูอาหาร</label>
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="food_name" type="text" placeholder="" 
                            name="food_name">
                        </div>
                        <br/><br/>
                        <label class="col-sm-3 col-xs-2 control-label">รายละเอียด</label>
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="food_detail" type="text" placeholder="" name="food_detail">
                        </div>
                    </div>
                    <div class="row">
