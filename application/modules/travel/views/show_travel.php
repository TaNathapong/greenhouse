  <div class="single-product-area">
   <div class="container">
      <div class="product-content-right">
        <!--เพิ่ม--><a href= "<?php echo site_url('travel/add_travel_page/')?>">
                            <button class="button">เพิ่มสถานที่ท่องเที่ยว</button>
                    </a>
                      ...
                      <div class="col-md-5 no-padding lib-item" data-category="view">
                          <div class="lib-panel">
                              ...
                              <a href= "<?php echo site_url('travel/delete_travel/'.$value['travel_id']);?>">
                                  ...
                                  <div class="col-md-6">
                                    <img src="<?php echo base_url('image_gh/'.$value['travel_pic']);?>" class="img-circle" alt="" width="304" height="236">
                                  </div>
                                  <div class="col-md-6">
