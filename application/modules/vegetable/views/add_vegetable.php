...
echo form_open_multipart('vegetable/add_vegetable',$attr);
?>
<div class="container">
        <div class="row">
...
<!--เพื่มรูป-->    <hr>
                ...
                <div class="card-body card-padding">
                    <div class="form-group">
                        <label class="col-sm-3 col-xs-2 control-label">ชื่อผัก</label>
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="vegetable_name" type="text" placeholder="" name="vegetable_name">
                        </div>
                        <br/><br/>
                        <label class="col-sm-3 col-xs-2 control-label">รายละเอียด</label>
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="vegetable_detail" type="text" placeholder="" name="vegetable_detail">
                        </div>
                        <br/><br/>
                        <label class="col-sm-3 col-xs-2 control-label">ราคา</label>
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="vegetable_pice" type="text" placeholder="" name="vegetable_pice">
                        </div>
                    </div>
                    <div class="row">
