...
echo form_open('member/add_post_product',$attr);
?>
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="single-sidebar">
                    ...
                    <ul>
                        <li><a href="" class="text-center" ><img src="img/Dark-Green.jpeg" width="100px" height="100px"><br>ผักสลัดกรีนโอ๊ค</a></li>
                        <li><a href="" class="text-center" ><img src="img/bell_chilli.jpg" width="100px" height="100px"><br>พริกหวาน</a></li>
                        <li><a href="" class="text-center" ><img src="img/broccoli.jpg" width="100px" height="100px"><br>บล็อคโคลี่</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-10">
                <div class="product-content-right">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="w3-content" style="max-width:1200px">
                                <center><img class="mySlides" src="<?php echo base_url ('dist/icon/addButton1.png');?>" style="width:65%"></center>
                            </div>
                        </div>
                            ...
                            <div class="product-inner ">
                                ...
                                <div class="row">
                                    <form action="/action_page.php">
                                        ...
                                        <div class="col-sm-9"><input class="form-control input-sm" type="name" name="product_name" style="margin-bottom:5px;"></div><br>
                                        <div class="col-sm-3">ชื่อลิงค์ :</div>
                                        <div class="col-sm-9"><input class="form-control input-sm" type="link" name="linkname"  style="margin-bottom:5px;"></div><br>
                                    </form>
                                </div><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3"><input class="form-control input-sm" type="price" name="product_price"  style="margin-bottom:5px;" ></div>
                                    <div class="col-sm-2">บาท/</div>
                                    <div class="col-sm-3"><input class="form-control input-sm" type="unit" name="product_unit"  style="margin-bottom:5px;"></div>
                    ...
                    <div class="related-products-wrapper">
                        ...
                        <div class="text-center"><button class="btn btn-success btn-lg">SAVE</button></div>
                    </div>
