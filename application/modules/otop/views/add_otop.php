...
echo form_open_multipart('otop/add_otop',$attr);
?>
<div class="container">
        <div class="row">
...
<!--เพื่มรูป-->    <hr>
                ...
                <div class="card-body card-padding">
                    <div class="form-group">
                        <label class="col-sm-3 col-xs-2 control-label">ชื่อสินค้า OTOP</label>
                        ...
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="otop_detail" type="text" placeholder="" name="otop_detail">
                        </div>
                    </div>
                    <div class="row">
