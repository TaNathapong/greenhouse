    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="footer-menu">
                ...
                <ul>
                    <li><a href="<?php echo site_url('vegetable/show_vegetable_page');?>">ผัก</a></li>
                    <li><a href="#">ผลไม้</a></li>
                    <li><a href="<?php echo site_url('otop/show_otop_page');?>">OTOP</a></li>
                    <li><a href="<?php echo site_url('processing/show_processing_page');?>">แปรรูป</a></li>
                    <li><a href="#">Premium</a></li>
                    <li><a href="<?php echo site_url('equipment/show_equipment_page');?>">อุปกรณ์การเกษตร</a></li>
                </ul>
            </div>
        </div>
