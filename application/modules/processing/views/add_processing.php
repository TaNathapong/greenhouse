...
echo form_open_multipart('processing/add_processing',$attr);
?>
<div class="container">
        <div class="row">
...
<!--เพื่มรูป-->    <hr>
                ...
                <div class="card-body card-padding">
                    <div class="form-group">
                        <label class="col-sm-3 col-xs-2 control-label">ชื่อสินค้า แปรรูป</label>
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="otop_name" type="text" placeholder="" 
                            name="processing_name" required="true">
                        </div>
                        <br/><br/>
                        <label class="col-sm-3 col-xs-2 control-label">รายละเอียด</label>
                        <div class="col-sm-9 col-xs-10">
                            <input class="form-control" id="otop_detail" type="text" placeholder="" name="processing_detail" required="true">
                        </div>
                    </div>
                    <div class="row">
